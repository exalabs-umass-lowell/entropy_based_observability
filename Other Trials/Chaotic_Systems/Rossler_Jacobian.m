...
% Observability of Rossler system for x/y/z by using the Jacobian matrix
...
title('variation of the x observability with Jacobian matrix');
grid on;
figure;
plot3(x(:,1),x(:,2),CD);
xlabel('x1');
ylabel('x2');
zlabel('observability index');
title('variation of the y observability with Jacobian matrix');
grid on;
figure;
plot3(x(:,1),x(:,2),EF);
xlabel('x1');
ylabel('x2');
zlabel('observability index');
title('variation of the z observability with Jacobian matrix');
grid on;
